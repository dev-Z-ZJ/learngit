				...
				<div class="box_1">
					...
					<div class="clearfix goodsBox" style="border: none;">
						<c:forEach items="${employList}" var="employ">
							<div class="goodsItem" style="padding: 10px 3px 45px 2px;">
								<a><img src="${employ.image }" alt="${employ.realname }"
									class="goodsimg" /> </a> <br />
								<div align="center">
									<a>${employ.realname }</a>
								</div>
								<a href="index/precate.action?skills=${employ.skills}&number=0" style="color: #68BCDD;" title="${employ.skills}" >
									${employ.skills}
								</a>
								<div>${employ.memo } </div>
							</div>
